  ...
  sections:
    - title: "Details"
      fields:
        ...
        - label: "Gravity (m/s2)"
          value: "~11.76"
        - label: "Atmospheric compostion"
          value:
            - "Nitrogen (N2): 65%"
            - "Oxygen (O2): 28%"
            - "Carbon Dioxide (CO2): 4%"
            - "Argon (Ar): 2%"
            - "Water Vapor (H2O), other elements: >1%"
        - label: "Satellites"
          value:
            - "Eye of Vordr"
            - "Eye of Visi"
...
import_source_file: "Location-Errack-e02.md"
import_issues:
  - "needs-era"
...
---
Nestled in the Degel system, Errack presents a paradox: a life-sustaining planet teeming with rich plant life and biodiversity, yet a world of savage beauty and unforgiving extremes. Towering mountains pierce skies above expansive jungles teeming with both vibrant life and lurking horrors, while arid deserts push the limits of ecological adaptation. Every corner of Errack showcases nature's ingenuity and ferocity, demanding respect and resilience from all who dare to inhabit it.  

## Orbital period

Most societies on Errack subscribe to the common calendar of: 364 days in a year - 13 months of 28 days, or 4 weeks of 7 days. Plus 1 inter-month day for "Zero-day" and an acompanying leap day every 4 years.  

### Seasons

Each of Errack's 4 seasons last approximately 3.25 months, In the old tongue, they are known as Vetrnaetr ("Winter nights", Winter), Blomvakning ("Bloom Awakening", Spring), Sumar (Summer), Haust ("Harvest", Autumn).
...
[![](500f0f5181785833ec0556ed7719194b.png "Errack Commission 0001.png")](/i/6407156 "Errack Commission 0001.png")
...
Across vast swathes of Errack's surface, Tideglass scars the landscape. These formations follow the Wyrdweave's webs and are often hotspots for [Resonants](/w/viscerium/a/resonance-article) due to the Wyrdweave's Resonance amplifying powers.
...
The species across Errack are vast and varied, for Errack’s living world is as savage as it is spectacular. Below is a selection of plants and creatures that are well known world-over and have persisted throughout the ages. More Flora and Fauna can be found within each era-specific category in the following sections linked below.  

### Flora

[CITADEL](/w/viscerium/c/flora-26-fungary-category)

[SMOG](/w/viscerium/c/flora-26-fungary-category-1-1)

[NEARSIGHT](/w/viscerium/c/flora-26-fungary-category-1-1-1)

[ENTROPY](/w/viscerium/c/flora-26-fungary-category-1)
...
[CITADEL](/w/viscerium/c/beastiary-category)

[SMOG](/w/viscerium/c/beastiary-category-1-1)

[NEARSIGHT](/w/viscerium/c/beastiary-category-1-1-1)

[ENTROPY](/w/viscerium/c/beastiary-category-1)
...
Errack is orbited by two moons, The Eye of Vordr and The Eye of Visi. One of these sibling moons is typically ~50km closer to Errack and as such orbits slightly faster than the other. Every 4-years the moons orbit close enough to eachother that they switch places and the further moon now becomes the closer moon, and vice-versa.  
...
[[#spoiler-SVYRFv|CITADEL]]

[[#spoiler-oybYTJ|SMOG]]

[[#spoiler-hc7YxC|NEARSIGHT]]

[[#spoiler-AnCWLY|ENTROPY]]

## Map of Errack

**CITADEL: Errack**

[Open full size](/w/viscerium/map/9b107a1b-5d12-487c-bcac-17f8df55df2d)
...
Overhead, a ghostly asteroid belt shimmers faintly, while two ominous moons cast an eerie glow upon the landscape, their celestial dance influencing the planet's volatile tides and magnetic fields. This asteroid belt is accentuated by large, sharp, crystaline-shaped rocks that make up the visage of a thorned crown around Errack's waist. These shards, orbital fortresses tethered to Errack are stations carved into, and reaching outwards, along one side of large asteroids that have been fetched from the far reaches of the Degel system, now bound to Errack by space elevator.   The use of such large, dense asteroids serves a dual purpose. Namely to act as a shield for the station-fortress and its tether by providing protection from Errack's asteroid belt. The secondary purpose is to provide a foundation upon which all manner of development can occur.  

## Map of Errack

 

### Use the tabs above to explore Errack throughout the eras
