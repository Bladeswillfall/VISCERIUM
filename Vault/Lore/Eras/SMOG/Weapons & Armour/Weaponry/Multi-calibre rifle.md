---
title: Multi-calibre rifle
status: draft
type: item
description: Firing two types of ammunition, this rifle has a secondary, larger barrel for single-shot firing when there's an unexpected or larger enemy that needs to go down, now.
updated:
