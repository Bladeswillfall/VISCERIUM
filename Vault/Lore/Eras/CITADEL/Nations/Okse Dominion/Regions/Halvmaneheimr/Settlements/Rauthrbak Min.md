    ...
    - title: Details
      fields:
        - label: Security Class
          value: Maximum, mixed gender
        - label: Location
          value: Halvmane Mountains
        - label: Estimated number of souls within
          value: 6,270
        - label: Govenor
          value: Vrangr Bláskegg
title: Rauthrbak Min
description: Nestled high amidst the Halvmane Mountains of the Lore/Eras/CITADEL/Okse Dominion, Rauthrbak Min (Redback Mine) stands as a chilling testament to the depths of human cruelty and suffering.
updated:
status: draft
type: location
...
import_source_file: Landmark-Rauthrbak Min-974.md
import_issues:
...
[Content warning(s):](#spoiler-RMwPgE)

Graphic content, reference to: torture, assault

[![Redback mine.png](/uploads/images/f5617a6b4db5089c2026dc2d26f716ab.png "Redback mine.png")](/i/4761417 "Redback mine.png")
...
Rauthrbak Min's name is synonymous with dread and horror, whispered in hushed tones among those who know of its existence. Its reputation as a pit of despair transcends its imposing walls, instilling fear in the hearts of even the most hardened criminals. The Okse Dominion, whether out of convenience or fear, allows this den of cruelty to persist, unknowingly fueling the hidden machinations of the cult that serves _The Seven_ - The Heptad Synod, orchestrating a symphony of suffering.
