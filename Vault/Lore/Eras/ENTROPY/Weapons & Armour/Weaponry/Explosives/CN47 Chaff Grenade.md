...
title: CN47 Chaff Grenade
status: draft
type: item
description: A smokescreen deploying grenade that poppulates the area with highly-reflective aluminium particles as well as traditional smoke creating compounds such as potassium chlorate.
updated:
development_level: stub
item_type: Weapon, Explosive
eras:
  - ENTROPY
