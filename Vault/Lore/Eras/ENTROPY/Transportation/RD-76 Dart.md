...
sidebar:
  ...
  meta:
    - label: "Role"
      value: "Dropship/Gunship"
    - label: "Manufacturer"
      value: "Sigd Aerospace"
  sections:
    - title: "Specifications"
      fields:
        - label: "Weight"
          value: "14,700kg (32,407lbs)"
        - label: "Crew"
          value: "4+8"
        - label: "Level flight top speed (VH)"
          value: "765km/h (475mph)"
        - label: "Design diving speed (VD)"
          value: "1358km/h (843mph)"
    - title: "Armament"
      fields:
        - label: "Nose gun"
          value: "KW-42 - 35x228mm, ABM or HESH rounds"
        - label: "Door gun(s)"
          value: "Mk.82 - 12.7x99mm, UVc rounds"
title: "RD-76 Dart"
description: "The RD-76 Dart is an Imperium Coalition multi-role craft capable of transatmospheric flight."
updated:
status: "draft"
type: "article"
...
The **RD-76 Dart** is an Imperium Coalition multi-role craft capable of transatmospheric flight. This has enabled the Dart to become the standard dropship for all three branches of the **IC**. The ICAV, ICDF and ICSC all field this craft consistently in a variety of operations due to its speed and versatility.   Designated **RD-76**, meaning **R**apid **D**eployment, model **76**, the Dart is capable of reaching supersonic speeds when in a nose-down dive within ten to twenty-seconds. Because of its supersonic capabilities, the Dart could deploy its cargo to the ground in roughly two-minutes from its refuelling altitude of around fifty-kilometres, thus, the _Rapid Deployment_ name.  
...
Two large SSTO _TA-42 "NovaStorm"_ engines provide the main propulsion for the RD-76, supplemented by two small VK-10 thrusters mounted under the nose.

#### Single-Stage-To-Orbit

Whilst the twin TA-42 engines are capable of flight in both atmosphere and vacuum, the Dart Dropship does not carry enough fuel to leave [Errack's](/w/viscerium/a/errack-location) gravity and as such, needs to be refuelled at the boundary of the stratosphere, just below the mesosphere.

> You see those two TA-42s there? You know why they call 'em NovaStorm, right? It's because they burn like those _relativistic jets_ you see coming out of black holes.  
> 
> — ICAV Engineer
...
The **KW**-**42** or **K**ampf**W**erkzeug, meaning **C**ombat **T**ool model **42** is a tri-barrel, chain-driven, 35mm auto-cannon, chambered in 35x228mm. It was deemed necessary to provide three barrels for this platform in order to prolong the life of each barrel and reduce heat soak in the chamber when firing caseless ammunition. Thus allowing the weapon to fire for longer periods of time without needing to cool down.   This auto-cannon is fitted with a dual feeder and a mechanical toggle to switch between the two. This allows the operator to fire one type of ammunition then quickly switch to another almost seamlessly.

#### mk.82 12.7mm machinegun
...
All rounds used by the Imperium Coalition are either **C**ased **T**elescopic **A**mmunition - **CTA** for short, or, **C**aseless **A**mmunition - **CA** for short. As such, ejection ports are still used on all weaponry for the purpose of clearing dud rounds in the case of CA ammunition or for clearing the case of a CTA round.
...
12.7x99mm UVc CA rounds. This caseless ammunition contains a small explosive charge and a mixture of dry chemicals that, upon detonation, burn at an incredibly high temperature whilst creating intense UVc light.
