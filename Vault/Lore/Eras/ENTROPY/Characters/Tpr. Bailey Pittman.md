    ...
    - title: "Appearance"
      fields:
        - label: "Eyes"
          value: "Blue, doe-eyed"
        - label: "Hair"
          value: "Auburn and copper balayage, medium length, wavy"
        - label: "Skin tone / pigmentation"
          value: "Pale white, freckled"
        - label: "Height"
          value: "5'4\" (1.62m)"
        - label: "Weight"
          value: "155lbs (70kg)"
        - label: "Physical traits"
          value: "Athletically fit with a bottom-heavy triangle _(pear)_ body shape"
    - title: "Membership"
      fields:
        - label: "Former"
          value:
        ...
        - label: "Current"
          value:
            ...
            - "Delta Two"
title: "Tpr. Bailey Pittman"
description: "Demolitions specialist for Delta Two One, quadruple amputee, and former ICDF reconnaissance rifleman."
created: 2021-08-11
...
imageTitle: "Tpr. Bailey Pittman"
artist: "Jake Saunders / MrBizcocho"
credit: "Jake Saunders / MrBizcocho"
sourceUrl: "https://twitter.com/Mrbizc8"
alt: "Portrait of Bailey Pittman, a freckled woman with auburn hair and blue eyes."
tags:
  - ENTROPY
  - Characters
---
...
>
> As Bailey's prosthetics are 'military-grade', they are built around a different set of priorities from civilian replacements. Their actuators favour speed, torque, impact tolerance and sustained load over delicate manipulation. She can sprint, climb, absorb hard landings and apply considerably more force than her natural limbs once could, but that performance comes at the expense of subtlety. Tasks that depend on fractions of pressure — gripping a glass, handling thin material or touching another person without watching her own hand — demand more conscious control.
>
> The same compromise exists in sensation. Bailey's specification uses a lower density of artificial sensory nerves, with pain signals deliberately reduced so that damage to a prosthetic does not incapacitate its operator as readily in combat. Position, resistance and contact can still be felt, but the information reaching her brain is weaker and less detailed than natural touch. A hand can tell her that it is holding something without always telling her, instinctively, whether it is holding too tightly.
>
> Years of training have made the limbs feel responsive in motion. Bailey does not need to think through every step or every movement of a finger. Fine control is different. She compensates with sight, repetition and learned restraint, especially after a prosthetic has taken an impact or been serviced. Small uncertainties that most people resolve through touch can become deliberate checks: how tightly she is holding something, whether a joint responded at the expected speed, whether somebody flinched when she reached for them.
>
> That uncertainty has become one of the central focuses of Bailey's obsessive-compulsive symptoms. Her fear is not usually that the prosthetics will fail catastrophically. It is that they will work exactly as designed while she misjudges the force she is applying. She trusts them to break through a door, carry a wounded trooper or keep fighting after an injury that would put somebody else on the ground. Trusting them with somebody she cares about is harder.
