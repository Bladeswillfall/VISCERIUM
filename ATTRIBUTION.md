# VISCERIUM Attribution and Creator Credit

## Creator credit

The primary creator credit is:

> **VISCERIUM created by Fall.**

The current authorship and provenance statement is:
...
VISCERIUM is intended to support credited contributions without fragmenting ownership of its core world or canon.

The intended model for an accepted creative contribution is:

1. The contributor signs separate written contributor terms.
2. Those terms define the rights assigned or licensed for the accepted material.
3. The terms define any applicable moral-rights waiver.
4. The terms define the contributor's agreed attribution.
5. Acceptance does not grant the contributor ownership of VISCERIUM or authority over canon.

A typical credit may use one of these forms:

> **Additional Lore contribution by [Contributor Name].**

> **Written by [Author Name], within the VISCERIUM universe created by Fall.**

> **Artwork by [Artist Name], for VISCERIUM created by Fall.**

The exact credit for a commissioned or franchised work must follow its signed agreement.

Attribution alone does not create copyright ownership, royalties, equity, approval rights, adaptation control, canon authority, or official partnership status.
...
A separate fan-content policy may later define permitted unofficial uses. Until then, no fan-use permission should be inferred from this attribution policy.

## Review point

This is a day-one attribution policy. Review it when any of these events occurs:

- NULL Holdings Ltd is incorporated;
