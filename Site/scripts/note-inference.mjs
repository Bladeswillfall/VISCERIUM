...
const FOLDER_ALIASES = [
  ...
  ['faith', 'belief'],
  ['faiths', 'belief'],
  ['naming', 'naming_language'],
  ['naming language', 'naming_language'],
  ['naming languages', 'naming_language'],
  ['language', 'naming_language'],
  ['languages', 'naming_language'],
  ['resonance', 'resonance_practice'],
  ['resonance practice', 'resonance_practice'],
  ['resonance practices', 'resonance_practice'],
  ['resonant practice', 'resonance_practice'],
  ['resonant practices', 'resonance_practice'],
  ['map', 'map'],
  ['maps', 'map'],
  ['image', 'image'],
  ['images', 'image'],
