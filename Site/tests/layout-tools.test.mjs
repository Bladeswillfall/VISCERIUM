...
const publicIndentStyles = readFileSync(new URL('../src/styles/layout.css', import.meta.url), 'utf8');
...
test('public Codex recognises visual indent markers without quotation chrome or scaffold labels', () => {
  assert.doesNotMatch(a11yStyles, /layout-indents\.css/);
  assert.match(publicIndentStyles, /Origin: layout-indents\.css/);
