...
test('automatic monthly catch-up archives only completed months and replays gaps', () => {
  assert.deepEqual(monthlyCatchupTasks('2026-08-01', '2026-09-14'), []);
  assert.deepEqual(monthlyCatchupTasks('2026-08-01', '2026-09-30'), [
    { kind: 'monthly', key: '2026-09-01', start: '2026-09-01', end: '2026-10-01' },
  ]);
  assert.deepEqual(monthlyCatchupTasks('2026-08-01', '2026-11-04'), [
    { kind: 'monthly', key: '2026-09-01', start: '2026-09-01', end: '2026-10-01' },
    { kind: 'monthly', key: '2026-10-01', start: '2026-10-01', end: '2026-11-01' },
  ]);
  assert.deepEqual(monthlyCatchupTasks(null, '2026-09-14'), [
    { kind: 'monthly', key: '2026-08-01', start: '2026-08-01', end: '2026-09-01' },
  ]);
});
