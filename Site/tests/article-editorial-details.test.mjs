...
const editorial = fs.readFileSync(path.join(root, 'src/styles/article-editorial.css'), 'utf8');
const eraContext = fs.readFileSync(path.join(root, 'src/styles/era-context.css'), 'utf8');
