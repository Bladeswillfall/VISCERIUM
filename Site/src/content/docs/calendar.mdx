...
title: Okse Calendar
description: >-
  The first implemented VISCERIUM calendar, rendered from structured calendar
  data and absolute world-time.
status: published
type: calendar
calendarBlocks:
  ID-0001:
...
<div class="codex-alpha-index__line"><a class="codex-alpha-index__link" href="/calendar/okse/">Okse Calendar Detail</a><span class="codex-alpha-index__meta">calendar</span></div>
<p class="codex-alpha-index__description">The Okse calendar detail route used by date badges and anchored calendar day links.</p>
</li>
</ul>
</section>
</div>
