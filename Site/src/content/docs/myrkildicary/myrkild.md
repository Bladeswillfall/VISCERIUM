...
title: Myrkild
description: >-
  Myrkild are symbiotic parasitic microorganisms, otherworldly scourges,
...
sidebar:
  ...
  meta:
    ...
    - label: Consistent features
      value:
        - >-
          A translucent outer membrane with various masses protruding outwards
          from the surface of the membrane, and a spiked icosahedral core.
...
The Horndbond, a sinister rite practised in the darkest corners of [Lore/Degel System/Errack](/degel-system/errack/), introduces a terrifying transformation of the flesh. A new organ, the Kildhornd - a small Myrkild construct, is inserted into the human body, just below and to the side of the heart, beneath the lower ribs.  
