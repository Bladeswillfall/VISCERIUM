...
title: Okse Dominion
description: >-
  A harsh mountain dominion of the Oksmun, built on endurance, fortification,
  oil, slave labour, and old Vetruxi blood.
status: published
type: faction
era: CITADEL
...
population: null
climate: >-
  Cold highland, tundra, temperate rainforest, coniferous forest, deciduous
  woodland
...
sidebar:
  ...
  meta:
    ...
    - label: Capital
      value: Valenheim
      href: >-
        [[Lore/Eras/CITADEL/Nations/Okse
        Dominion/Regions/Halvmaneheimr/Settlements/Valenheim|Valenheim]]
  sections:
    - title: Leadership
      fields:
        - label: Kónungsson
...
slug: eras/citadel/nations/okse-dominion
eraStyle: e1
links:
  - eras/citadel/nations/krass-dominion/
sourcePath: Eras/CITADEL/Nations/Okse Dominion/Okse Dominion.md
giscus: true
referencedIn:
  - title: Valenheim
    href: >-
...
His younger brother Asgrim Torradsson chose differently. The [Krass Dominion](/eras/citadel/nations/krass-dominion/) turned inward, holding tighter to local land, older traditions and a less centralised inheritance of Vetruxi life. To Oksmun eyes, the Krass chose the easier path. To Krassians, the Okse mistook hardship for virtue and then built a government to enforce it.
...
## Power Under Seal
Few Resonants emerge within the Dominion, but those who do are too useful to be left alone. Muld and Svar affinities are the clearest examples.
...
**[Valenheim](/eras/citadel/nations/okse-dominion/regions/halvmaneheimr/settlements/valenheim/)** — The Dominion's fortified heart, where black stone, river trade, Resonant engineering and industrial growth gather behind the Mestrvirki.
...
**Vagrvik** — A bustling city between two rivers, linked to Valenheim by the Issvatn and home to the Dominion's largest port, Hofn Heillfranvagr.
...
**Strondverdir** — A western-gulf city guarding approaches toward Askal, tied inland by a north-south road sheltered beneath the coastal mountains.
