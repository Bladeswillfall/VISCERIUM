...
description: >-
  NON-CANON Atlas test overlay using the real CITADEL map of Errack to verify
  raster rendering, search, layers, marker types, zoom thresholds, nested maps,
  and plugin-backed visual authoring.
status: published
type: map
era: CITADEL
...
related:
  ...
  - Demo Frontier Fort
  - Demo Rift Site
slug: demo/exploration-demo-world
eraStyle: e1
links:
  - demo/demo-gate-city/
